...
function initMap() {
  ...
  if ($googlemaps.length && window.google) {
    $googlemaps.forEach( /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(itm) {
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 24:
              ...
              themeController && themeController.addEventListener('clickControl', function (_ref2) {
                var control = _ref2.detail.control;
                if (control === 'theme') {
                  destroyMap(map);
                  initMap();
                }
...
var cookieNoticeInit = function cookieNoticeInit() {
  ...
  btnNoticeToggle && btnNoticeToggle.addEventListener(Events.CLICK, function (_ref3) {
...
var progressBarInit = function progressBarInit() {
  ...
  if (progressCircle.length) {
    progressCircle.forEach(function (item) {
      ...
      document.body.addEventListener('clickControl', function (_ref4) {
        var control = _ref4.detail.control;
        if (control === 'theme') {
